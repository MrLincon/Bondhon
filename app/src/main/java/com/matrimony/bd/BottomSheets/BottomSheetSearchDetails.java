...
import com.matrimony.bd.Activity.BioDataNumberResultActivity;
...
public class BottomSheetSearchDetails extends BottomSheetDialogFragment {
    ...
    TextView name, maritalCondition, permanentAddress, permanentDistrict, currentAddress, currentDistrict,
            ...
            expectedFamilyCondition, expectedLifePartnerQualities, requestText;

    CardView requestDetails;
    ...
    public BottomSheetSearchDetails() {
    }

    @Nullable
    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.bottom_sheet_search_details, container, false);
        ...
        requestDetails = view.findViewById(R.id.request_details);
        requestText = view.findViewById(R.id.request_text);


        BioDataNumberResultActivity activity = (BioDataNumberResultActivity) getActivity();
        ...
        requestDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String Status = requestText.getText().toString();

                if (Status.equals("রিকুয়েস্ট ক্যানসেল করুন")){
                    db.collection("userDetails").document(ItemID).collection("pendingRequest").document(userID).delete();
                    requestText.setText("রিকুয়েস্ট কন্টাক্ট ডিটেলস");
                }else {
                    if (!ItemID.equals(userID)){
                            ...
                            public void onSuccess(DocumentSnapshot documentSnapshot) {
                                if (documentSnapshot.exists()) {
                                    ...
                                    if (bioDataNumber==null){
                                        Toast.makeText(getContext(), "আপনার প্রোফাইল টি সম্পূর্ণ করুন", Toast.LENGTH_SHORT).show();
                                    }else{
                                        doc_ref = db.collection("userDetails").document(ItemID).collection("pendingRequest").document(userID);
                                        ...
                                        doc_ref.set(userMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                requestText.setText("রিকুয়েস্ট ক্যানসেল করুন");
                                            }
                        ...
                        Toast.makeText(getContext(), "এটি আপনার নিজস্ব আইডি", Toast.LENGTH_SHORT).show();
                    }
                }
    ...
    private void requestStatus() {
        ...
        try {
            DocumentReference docIdRef = db.collection("userDetails").document(ItemID).collection("pendingRequest").document(userID);
